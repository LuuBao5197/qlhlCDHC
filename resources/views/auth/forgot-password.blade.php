          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <p class="text-muted">Nhập email tài khoản của bạn. Yêu cầu sẽ được gửi tới Admin để duyệt trước khi bạn có thể đặt mật khẩu mới.</p>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-block enter-btn">Gửi yêu cầu đặt lại mật khẩu</button>
                  </div>
