...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::xNfkjtb3NsU7G68A',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::s6KOiOdvugXJimH1',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::OD3VqaWoRMGCBES7',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::x9VQJBwTuqq5rrpq',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/a(?|dmin/users/([^/]++)/(?|approve(*:42)|reject(*:55))|pi/v1/schedules/([^/]++)(?|(*:90)))|/s(?|chedules/([^/]++)(?|(*:124)|/(?|edit(*:140)|s(?|ubmit(*:157)|emester\\-events(?|(*:183)|/([^/]++)(?|(*:203)))))|(*:215))|emester(?|(?:/([^/]++)(?:/([^/]++)(?:/([^/]++))?)?)?(*:276)|\\-schedule(?:/([^/]++)(?:/([^/]++)(?:/([^/]++))?)?)?(*:336))|torage/(.*)(?|(*:359)))|/m(?|onthly\\-schedules/([^/]++)/(?|assignment(?|(*:417))|slot(?|s/([^/]++)/merge(?|\\-candidates(*:464)|(*:472))|\\-groups/([^/]++)/split(*:504))|department\\-monthly\\-assignment\\-batches/submit(*:560)|teaching\\-support\\-requests(?|(*:598)|/modal(*:612)))|anagement/(?|t(?|raining\\-(?|programs/([^/]++)(?|(*:671))|batches/([^/]++)(?|(*:699))|classes/([^/]++)(?|(*:727)))|eachers/([^/]++)(?|(*:756)))|departments/([^/]++)(?|(*:789))|rooms/([^/]++)(?|(*:815))|s(?|ubject(?|s/([^/]++)(?|(*:850))|\\-lessons/([^/]++)(?|(*:880)))|tudents/([^/]++)(?|(*:909)))))|/department\\-monthly\\-assignment\\-batches/([^/]++)(?|(*:974)|/(?|approve(*:993)|return(*:1007)))|/teaching\\-support\\-(?|request(?|s/([^/]++)(?|(*:1064)|/(?|review(*:1083)|withdraw(*:1100)|c(?|onfirm(*:1119)|hange\\-requests(?|/create(*:1153)|(*:1162)))))|\\-items/([^/]++)/assign(*:1198))|change\\-requests/([^/]++)(?|(*:1236)|/review(*:1252)))|/change\\-requests/([^/]++)/review(*:1296)|/holiday\\-calendars/([^/]++)(?|(*:1336)))/?$}sDu',
    ),
    3 => 
    array (
      42 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:822:"function () {
                ...
                }";s:5:"scope";s:54:"Illuminate\\Foundation\\Configuration\\ApplicationBuilder";s:4:"this";N;s:4:"self";s:32:"0000000000000a280000000000000000";}}',
        'as' => 'generated::xNfkjtb3NsU7G68A',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\AuthController@showRegisterForm',
        'controller' => 'App\\Http\\Controllers\\Auth\\AuthController@showRegisterForm',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000009ce0000000000000000";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'generated::OD3VqaWoRMGCBES7',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminController@approve',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminController@approve',
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminController@reject',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminController@reject',
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:39:"E:\\Em trai\\qlhlCDHC\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:323:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"0000000000000a2d0000000000000000";}}',
        'as' => 'storage.local',
      ),
      'fallback' => false,
      'defaults' => 
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:39:"E:\\Em trai\\qlhlCDHC\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:325:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"00000000000009db0000000000000000";}}',
